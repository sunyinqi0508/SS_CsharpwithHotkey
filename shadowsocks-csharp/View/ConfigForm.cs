...
namespace Shadowsocks.View
{
    public partial class ConfigForm : Form
    {
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                HotkeyManagement.register(this.Handle);
                MessageBox.Show("reg");
            }
            else
            {
                HotkeyManagement.unregister(this.Handle);
            }
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            {
                case WM_HOTKEY:
                    // MessageBox.Show("" + (int)m.WParam);
                    switch ((int)m.WParam)
                    {
                        case 508:
                            //MessageBox.Show("Toggled");
                            this.menu.EnableItem_Click(null, null);
                            break;
                    }
                    break;
            }
