...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        public void changeCheckboxState(bool check)
        {
            if (check)
                HotkeyManagement.register(configForm.Handle);
            configForm.checkBox1.CheckState = check? CheckState.Checked : CheckState.Unchecked;
        }
        private void ShowConfigForm()
        {
            if (configForm != null)
            {
               // configForm.Deactivate(new EventHandler());
                configForm.Show();
            }
            else
            {
                configForm = new ConfigForm(controller, null);
                //configForm.
                configForm.Show();
        ...
        public void EnableItem_Click(object sender, EventArgs e)
        {
